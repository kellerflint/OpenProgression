/* Insert Test Users */
INSERT INTO `OpenProgression`.`User` (`user_id`, `user_name`, `user_nickname`, `user_password`, `user_hashed_password`, `user_experience`) VALUES ('1', 'SYSTEM', 'SYSTEM', '1234', '1234', '0');
