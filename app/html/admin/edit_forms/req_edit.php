...
if (isset($_GET["action_type"])) {
    ...
    <form action="progression_edit.php" METHOD="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="req-name" name="req_name"
                   value="<?php echo $req["req_name"]; ?>">
        </div>
        <div class="form-group">
            <label for="req_text">Text</label>
            <textarea class="form-control" id="req-text" name="req_text"
                      rows="3"><?php echo $req["req_text"]; ?></textarea>
        </div>
        <div class="form-group">
            <label for="req_link">Link</label>
            <textarea class="form-control" id="req-link" name="req_link"
                      rows="2"><?php echo $req["req_link"]; ?></textarea>
        </div>
        <div class="form-group">
